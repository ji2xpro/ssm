...
-- ----------------------------
BEGIN;
INSERT INTO `sys_user` VALUES (1, '测试用户6', 'User6', 20, 'Slave', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO `sys_user` VALUES (2, '测试用户7', 'User7', 22, 'Slave', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO `sys_user` VALUES (3, '测试用户8', 'User8', 24, 'Slave', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
COMMIT;
